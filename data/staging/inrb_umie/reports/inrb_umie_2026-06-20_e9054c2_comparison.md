...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-06-20_e9054c2_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `e9054c2`
- Build manifest : `368aa8b`, `2026-06-19T14:17:47+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 115
- Dates staging : 2026-05-14 -> 2026-06-17 (32 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-15 (30 dates distinctes)
- Correspondances exactes champ par champ : 104
- Ecarts ou absences dans `counts.csv` : 8
