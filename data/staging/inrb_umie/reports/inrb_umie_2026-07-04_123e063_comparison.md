...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-07-04_123e063_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `123e063`
- Build manifest : `bf2ecd6`, `2026-07-03T11:14:54+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 163
- Dates staging : 2026-05-14 -> 2026-07-01 (44 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 45
- Valeurs manquantes / `ND` / lignes staging absentes : 16
- Baisses detectees dans les series staging : 28
