...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-07-07_fd719bb_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `fd719bb`
- Build manifest : `fb3eca2`, `2026-07-06T15:16:12+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 175
- Dates staging : 2026-05-14 -> 2026-07-04 (47 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 57
- Valeurs manquantes / `ND` / lignes staging absentes : 16
- Baisses detectees dans les series staging : 29
