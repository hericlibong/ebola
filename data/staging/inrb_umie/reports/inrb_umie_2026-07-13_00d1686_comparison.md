...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-07-13_00d1686_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `00d1686`
- Build manifest : `93e2735`, `2026-07-12T20:36:43+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 195
- Dates staging : 2026-05-14 -> 2026-07-09 (52 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 77
- Valeurs manquantes / `ND` / lignes staging absentes : 16
- Baisses detectees dans les series staging : 33
