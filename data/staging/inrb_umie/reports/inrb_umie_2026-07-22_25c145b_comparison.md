...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-07-22_25c145b_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `25c145b`
- Build manifest : `8e2e7e4`, `2026-07-21T22:40:52+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 218
- Dates staging : 2026-05-14 -> 2026-07-19 (59 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 100
- Valeurs manquantes / `ND` / lignes staging absentes : 21
- Baisses detectees dans les series staging : 36
