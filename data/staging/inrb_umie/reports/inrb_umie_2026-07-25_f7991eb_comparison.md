...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-07-25_f7991eb_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `f7991eb`
- Build manifest : `4abd294`, `2026-07-24T10:58:41+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 224
- Dates staging : 2026-05-14 -> 2026-07-22 (61 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 106
- Valeurs manquantes / `ND` / lignes staging absentes : 23
- Baisses detectees dans les series staging : 37
