...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-08-02_7a42331_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `7a42331`
- Build manifest : `dcb25d3`, `2026-08-01T14:18:42+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 239
- Dates staging : 2026-05-14 -> 2026-07-30 (66 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 121
- Valeurs manquantes / `ND` / lignes staging absentes : 28
- Baisses detectees dans les series staging : 40
