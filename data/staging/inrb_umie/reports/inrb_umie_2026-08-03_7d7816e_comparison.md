...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-08-03_7d7816e_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `7d7816e`
- Build manifest : `e9ab918`, `2026-08-02T12:39:34+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 242
- Dates staging : 2026-05-14 -> 2026-07-31 (67 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 124
- Valeurs manquantes / `ND` / lignes staging absentes : 29
- Baisses detectees dans les series staging : 41
