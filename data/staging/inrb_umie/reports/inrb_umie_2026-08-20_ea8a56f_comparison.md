...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-08-20_ea8a56f_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `ea8a56f`
- Build manifest : `6f50205`, `2026-08-20T06:51:45+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 266
- Dates staging : 2026-05-14 -> 2026-08-17 (77 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 148
- Valeurs manquantes / `ND` / lignes staging absentes : 45
