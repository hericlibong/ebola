...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-08-31_56e9ee6_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `56e9ee6`
- Build manifest : `1519405`, `2026-08-28T14:32:43+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 280
- Dates staging : 2026-05-14 -> 2026-08-28 (84 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-06-18 (33 dates distinctes)
- Correspondances exactes champ par champ : 115
- Ecarts ou absences dans `counts.csv` : 162
- Valeurs manquantes / `ND` / lignes staging absentes : 59
...
| 2026-07-27 | `confirmed_cases` | 3360 | missing | value absent from counts.csv |
| 2026-07-27 | `suspected_cases` | 321 | missing | value absent from counts.csv |
| 2026-07-27 | `confirmed_deaths` | 1487 | missing | value absent from counts.csv |
| 2026-07-30 | `confirmed_cases` | 3605 | missing | value absent from counts.csv |
| 2026-07-30 | `suspected_cases` | 374 | missing | value absent from counts.csv |
| 2026-07-30 | `confirmed_deaths` | 1587 | missing | value absent from counts.csv |
| 2026-07-31 | `confirmed_cases` | 3674 | missing | value absent from counts.csv |
| 2026-07-31 | `suspected_cases` | 321 | missing | value absent from counts.csv |
| 2026-07-31 | `confirmed_deaths` | 1621 | missing | value absent from counts.csv |
| 2026-08-01 | `confirmed_cases` | 3748 | missing | value absent from counts.csv |
| 2026-08-01 | `suspected_cases` | 227 | missing | value absent from counts.csv |
| 2026-08-01 | `confirmed_deaths` | 1657 | missing | value absent from counts.csv |
| 2026-08-02 | `confirmed_cases` | 3802 | missing | value absent from counts.csv |
| 2026-08-02 | `suspected_cases` | 275 | missing | value absent from counts.csv |
| 2026-08-02 | `confirmed_deaths` | 1707 | missing | value absent from counts.csv |
| 2026-08-03 | `confirmed_cases` | 3874 | missing | value absent from counts.csv |
| 2026-08-03 | `suspected_cases` | 301 | missing | value absent from counts.csv |
| 2026-08-03 | `confirmed_deaths` | 1751 | missing | value absent from counts.csv |
| 2026-08-04 | `confirmed_cases` | 3973 | missing | value absent from counts.csv |
| 2026-08-04 | `suspected_cases` | 270 | missing | value absent from counts.csv |
| 2026-08-04 | `confirmed_deaths` | 1801 | missing | value absent from counts.csv |
| 2026-08-08 | `confirmed_cases` | 4209 | missing | value absent from counts.csv |
| 2026-08-08 | `confirmed_deaths` | 1916 | missing | value absent from counts.csv |
| 2026-08-09 | `confirmed_cases` | 4381 | missing | value absent from counts.csv |
| 2026-08-09 | `confirmed_deaths` | 2011 | missing | value absent from counts.csv |
| 2026-08-10 | `confirmed_cases` | 4449 | missing | value absent from counts.csv |
| 2026-08-10 | `confirmed_deaths` | 2061 | missing | value absent from counts.csv |
| 2026-08-11 | `confirmed_cases` | 4566 | missing | value absent from counts.csv |
| 2026-08-11 | `confirmed_deaths` | 2128 | missing | value absent from counts.csv |
| 2026-08-15 | `confirmed_cases` | 4945 | missing | value absent from counts.csv |
| 2026-08-15 | `confirmed_deaths` | 2325 | missing | value absent from counts.csv |
| 2026-08-17 | `confirmed_cases` | 5105 | missing | value absent from counts.csv |
| 2026-08-17 | `confirmed_deaths` | 2420 | missing | value absent from counts.csv |
| 2026-08-19 | `confirmed_cases` | 5290 | missing | value absent from counts.csv |
| 2026-08-19 | `confirmed_deaths` | 2516 | missing | value absent from counts.csv |
| 2026-08-20 | `confirmed_cases` | 5375 | missing | value absent from counts.csv |
| 2026-08-20 | `confirmed_deaths` | 2557 | missing | value absent from counts.csv |
| 2026-08-22 | `confirmed_cases` | 5514 | missing | value absent from counts.csv |
| 2026-08-22 | `confirmed_deaths` | 2642 | missing | value absent from counts.csv |
| 2026-08-24 | `confirmed_cases` | 5656 | missing | value absent from counts.csv |
| 2026-08-24 | `confirmed_deaths` | 2715 | missing | value absent from counts.csv |
| 2026-08-25 | `confirmed_cases` | 5713 | missing | value absent from counts.csv |
| 2026-08-25 | `confirmed_deaths` | 2755 | missing | value absent from counts.csv |
| 2026-08-26 | `confirmed_cases` | 5794 | missing | value absent from counts.csv |
| 2026-08-26 | `confirmed_deaths` | 2786 | missing | value absent from counts.csv |
| 2026-08-28 | `confirmed_cases` | 5945 | missing | value absent from counts.csv |
| 2026-08-28 | `confirmed_deaths` | 2862 | missing | value absent from counts.csv |
