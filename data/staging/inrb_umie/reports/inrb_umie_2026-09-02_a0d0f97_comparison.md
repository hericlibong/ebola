...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-02_a0d0f97_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `a0d0f97`
- Build manifest : `afdaddb`, `2026-09-01T09:25:38+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 282
- Dates staging : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
...
- Valeurs manquantes / `ND` / lignes staging absentes : 61
