...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-08_9382c8d_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `9382c8d`
- Build manifest : `f5d3ef3`, `2026-09-07T09:44:40+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 294
- Dates staging : 2026-05-14 -> 2026-09-05 (91 dates distinctes)
...
- Valeurs manquantes / `ND` / lignes staging absentes : 73
