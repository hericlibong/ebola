...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-09_1947fed_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `1947fed`
- Build manifest : `bb0583b`, `2026-09-08T11:59:58+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 296
- Dates staging : 2026-05-14 -> 2026-09-06 (92 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 15
- Valeurs manquantes / `ND` / lignes staging absentes : 75
