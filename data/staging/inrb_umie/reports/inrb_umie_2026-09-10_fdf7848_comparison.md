...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-10_fdf7848_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `fdf7848`
- Build manifest : `041a758`, `2026-09-09T11:26:50+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 298
- Dates staging : 2026-05-14 -> 2026-09-07 (93 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 17
- Valeurs manquantes / `ND` / lignes staging absentes : 77
