...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-11_1ea7634_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `1ea7634`
- Build manifest : `cbfef43`, `2026-09-11T09:51:23+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 302
- Dates staging : 2026-05-14 -> 2026-09-09 (95 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 21
- Valeurs manquantes / `ND` / lignes staging absentes : 81
