...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-16_3cd58b1_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `3cd58b1`
- Build manifest : `07085a4`, `2026-09-15T12:10:25+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 306
- Dates staging : 2026-05-14 -> 2026-09-13 (97 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 25
- Valeurs manquantes / `ND` / lignes staging absentes : 85
