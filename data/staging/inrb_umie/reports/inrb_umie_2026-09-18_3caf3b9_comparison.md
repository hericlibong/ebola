...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-18_3caf3b9_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `3caf3b9`
- Build manifest : `2230417`, `2026-09-17T11:51:41+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 308
- Dates staging : 2026-05-14 -> 2026-09-15 (98 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 27
- Valeurs manquantes / `ND` / lignes staging absentes : 87
