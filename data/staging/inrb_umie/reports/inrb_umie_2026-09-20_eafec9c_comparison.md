...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-20_eafec9c_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `eafec9c`
- Build manifest : `7568ad3`, `2026-09-18T11:12:30+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 310
- Dates staging : 2026-05-14 -> 2026-09-16 (99 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 29
- Valeurs manquantes / `ND` / lignes staging absentes : 89
...
| 2026-09-16 | `confirmed_deaths` | 3605 | missing | value absent from counts.csv |
