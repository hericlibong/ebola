...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-23_f489a92_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `f489a92`
- Build manifest : `fbd3181`, `2026-09-21T10:47:19+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 311
- Dates staging : 2026-05-14 -> 2026-09-19 (100 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 30
- Valeurs manquantes / `ND` / lignes staging absentes : 92
