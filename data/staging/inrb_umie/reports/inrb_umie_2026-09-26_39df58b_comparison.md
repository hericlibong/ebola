...
- Snapshot staging : `data/staging/inrb_umie/snapshots/inrb_umie_2026-09-26_39df58b_national_counts.csv`
- Reference locale : `public/data/reference/counts.csv`
- Entite comparee : `drc_total`
- Commit upstream INRB-UMIE : `39df58b`
- Build manifest : `c40efc1`, `2026-09-23T13:19:28+00:00`
- Statut : comparaison de travail, aucune validation editoriale automatique

## Resume

- Lignes staging : 313
- Dates staging : 2026-05-14 -> 2026-09-21 (101 dates distinctes)
- Dates `counts.csv` pour `drc_total` : 2026-05-14 -> 2026-08-30 (85 dates distinctes)
- Correspondances exactes champ par champ : 278
- Ecarts ou absences dans `counts.csv` : 32
- Valeurs manquantes / `ND` / lignes staging absentes : 94
...
| 2026-09-02 | `confirmed_cases` | 6342 | missing | value absent from counts.csv |
| 2026-09-02 | `confirmed_deaths` | 3072 | missing | value absent from counts.csv |
| 2026-09-03 | `confirmed_cases` | 6436 | missing | value absent from counts.csv |
| 2026-09-03 | `confirmed_deaths` | 3095 | missing | value absent from counts.csv |
| 2026-09-04 | `confirmed_cases` | 6522 | missing | value absent from counts.csv |
| 2026-09-04 | `confirmed_deaths` | 3134 | missing | value absent from counts.csv |
| 2026-09-05 | `confirmed_cases` | 6604 | missing | value absent from counts.csv |
| 2026-09-05 | `confirmed_deaths` | 3175 | missing | value absent from counts.csv |
| 2026-09-06 | `confirmed_cases` | 6686 | missing | value absent from counts.csv |
| 2026-09-06 | `confirmed_deaths` | 3226 | missing | value absent from counts.csv |
| 2026-09-07 | `confirmed_cases` | 6757 | missing | value absent from counts.csv |
| 2026-09-07 | `confirmed_deaths` | 3267 | missing | value absent from counts.csv |
| 2026-09-08 | `confirmed_cases` | 6843 | missing | value absent from counts.csv |
| 2026-09-08 | `confirmed_deaths` | 3310 | missing | value absent from counts.csv |
| 2026-09-09 | `confirmed_cases` | 6942 | missing | value absent from counts.csv |
| 2026-09-09 | `confirmed_deaths` | 3349 | missing | value absent from counts.csv |
| 2026-09-10 | `confirmed_cases` | 7022 | missing | value absent from counts.csv |
| 2026-09-10 | `confirmed_deaths` | 3398 | missing | value absent from counts.csv |
| 2026-09-13 | `confirmed_cases` | 7258 | missing | value absent from counts.csv |
| 2026-09-13 | `confirmed_deaths` | 3510 | missing | value absent from counts.csv |
| 2026-09-15 | `confirmed_cases` | 7404 | missing | value absent from counts.csv |
| 2026-09-15 | `confirmed_deaths` | 3577 | missing | value absent from counts.csv |
| 2026-09-16 | `confirmed_cases` | 7475 | missing | value absent from counts.csv |
| 2026-09-19 | `confirmed_cases` | 7672 | missing | value absent from counts.csv |
| 2026-09-19 | `confirmed_deaths` | 3699 | missing | value absent from counts.csv |
| 2026-09-21 | `confirmed_cases` | 7773 | missing | value absent from counts.csv |
| 2026-09-21 | `confirmed_deaths` | 3759 | missing | value absent from counts.csv |
...
| 2026-09-02 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-02 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-03 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-03 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-04 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-04 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-05 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-05 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-06 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-06 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-07 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-07 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-08 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-08 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-09 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-09 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-10 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-10 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-13 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-13 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-15 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-15 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-16 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-16 | `confirmed_deaths` | staging missing/ND | missing |
| 2026-09-16 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-19 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-19 | `suspected_deaths` | staging missing/ND | missing |
| 2026-09-21 | `suspected_cases` | staging missing/ND | missing |
| 2026-09-21 | `suspected_deaths` | staging missing/ND | missing |
